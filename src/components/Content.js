            ...
            return(
                ...
                <div key={i} className="col-12 col-md-6 col-lg-3 movieMedia">
                    <div className="media d-inline-block">
                        <img className="mt-2 img-thumbnail align-self-center mainImageThumbnail" src={movie.Poster} />
                            ...
                            <ModalBody className="align-items-center justify-content-center">
                                <div className="card">
                                    <div className="card-body d-block">
                                        <img className="ml-2 col-12 col-lg-6 order-first p-4 img-thumbnail thumbImage" src={this.state.data.Poster} />
